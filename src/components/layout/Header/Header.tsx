...
export const Header = () => {
  return (
    <header className="order-2 h-[100px] w-full fixed bg-[var(--accent-color)] rounded-tl-[20px] rounded-tr-[20px] sm:h-screen sm:rounded-r-[20px] sm:rounded-l-0 font-title bottom-0">
      <nav className="h-full pt-[20px]">
        <ul className="flex sm:flex-col h-full justify-around">
          <li>
            <Link
              className="w-[40px] flex flex-col items-center transition ease-in-out duration-200 hover:scale-105 active:underline-offset-1"
              href={ROUTES.main}>
          ...
          <li className="flex flex-col items-center">
            <Link
              className="w-[40px] flex flex-col items-center transition ease-in-out duration-200 hover:scale-105"
